 ...
 *
 * Inputs:
 * - Imports: react, @tanstack/react-query, @tanstack/react-virtual, react-router-dom, @/components/ui/Button, @/components/ui/ConfirmDialog, @/components/ui/Dialog; additional imports omitted for brevity
 *
 * Outputs:
