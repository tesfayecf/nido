<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/ingestion`.
Responsibilities:
...
Owns source/property tracking, field/tag metadata, parsing orchestration, and scheduled property refreshes.

## Contained components

Application services, browser renderer, connectors, domain models, and HTTP transport.
...
Consumes fetcher/parser/platform; downstream engagement and platformops use events and summaries.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Ingestion Module"]
