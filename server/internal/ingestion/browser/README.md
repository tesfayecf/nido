<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/ingestion/browser`.
Responsibilities:
...
Provides optional rendered-page retrieval abstraction.

## Contained components

Renderer interface and command renderer implementation.
...
Consumed by HTML listing workflows when browser rendering is configured.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Browser Rendering Adapter"]
