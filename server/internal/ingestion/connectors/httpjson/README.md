<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/ingestion/connectors/httpjson`.
Responsibilities:
...
Fetches structured JSON source payloads.

## Contained components

Connector implementation for HTTP JSON sources.
...
Depends on fetcher and parser/httpjson.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["HTTP JSON Connector"]
