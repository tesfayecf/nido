<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/ingestion/connectors/htmllistings`.
Responsibilities:
...
# HTML Listings Connector

## Purpose

Fetches and parses HTML listing pages.

## Contained components

Connector implementation and tests for HTML listing sources.
...
Depends on fetcher, optional browser renderer, and parser/htmllistings.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["HTML Listings Connector"]
