<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/ingestion/transport`.
Responsibilities:
...
# Ingestion Transport Boundary

## Purpose

Groups ingestion HTTP adapters.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Ingestion Transport Boundary"]
