<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/parser/htmljsonld`.
Responsibilities:
...
Extracts listing fields from JSON-LD embedded in HTML.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["HTML JSON-LD Parser"]
