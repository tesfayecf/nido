<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/parser`.
Responsibilities:
...
Groups payload parsers for supported source formats.

## Contained components

HTTP JSON, HTML listing, and HTML JSON-LD parser subfolders.
...
Consumed by ingestion connectors.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Parser Module"]
