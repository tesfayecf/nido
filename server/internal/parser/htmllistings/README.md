<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/parser/htmllistings`.
Responsibilities:
...
# HTML Listings Parser

## Purpose

Extracts listing fields from configured HTML selectors.
...
Consumed by HTML listings connector.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["HTML Listings Parser"]
