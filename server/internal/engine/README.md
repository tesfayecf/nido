<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/engine`.
Responsibilities:
...
Provides shared retry and worker-pool primitives.

## Contained components

Worker pool, retry helpers, and classified errors.
...
Consumed by ingestion scheduler and other concurrent workflows.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Execution Engine"]
