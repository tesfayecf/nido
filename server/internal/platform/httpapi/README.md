<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/platform/httpapi`.
Responsibilities:
...
# HTTP Platform Helpers

## Purpose

Provides shared HTTP parsing, JSON, pagination, CORS, logging, and SSE helpers.

## Contained components

Request parsing, response writing, middleware, and tests.
...
Consumed by all HTTP transport packages and runtime.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["HTTP Platform Helpers"]
