<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/platform/objectstore`.
Responsibilities:
...
Abstracts binary/object storage.

## Contained components

Memory and S3 implementations plus store contract.
...
Available to backend workflows that need object persistence.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Object Store Platform"]
