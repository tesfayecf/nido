<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/platform/events`.
Responsibilities:
...
Consumed by ingestion, engagement, and platformops notification flows.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Event Platform"]
