<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/platform/id`.
Responsibilities:
...
Consumed by services that create persisted records.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["ID Platform"]
