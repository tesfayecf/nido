<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/platformops`.
Responsibilities:
...
Owns settings, workspace backup/restore, scheduler summaries, delivery logs, and integration delivery.

## Contained components

Application, domain, and HTTP transport packages.
...
Depends on ingestion scheduler, platform events/config, and SQLite backup stores.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Platform Operations Module"]
