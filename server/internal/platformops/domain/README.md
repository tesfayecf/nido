<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/platformops/domain`.
Responsibilities:
...
# Platform Operations Domain Layer

## Purpose

Defines settings, backup, scheduler summary, and delivery log contracts.

## Contained components

Backup normalization and operational data models.
...
Consumed by platformops service, HTTP transport, and SQLite stores.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Platform Operations Domain Layer"]
