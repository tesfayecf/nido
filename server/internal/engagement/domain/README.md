<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/engagement/domain`.
Responsibilities:
...
# Engagement Domain Layer

## Purpose

Defines engagement data contracts.

## Contained components

Bookmark, alert, notification, and related models.
...
Consumed by engagement services, transport, and SQLite.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Engagement Domain Layer"]
