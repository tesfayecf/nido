<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/engagement`.
Responsibilities:
...
Owns bookmarks, alerts, notifications, and engagement events.
...
Consumes ingestion property models and platform events; feeds operator UI state.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Engagement Module"]
