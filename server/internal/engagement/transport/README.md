<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/engagement/transport`.
Responsibilities:
...
# Engagement Transport Boundary

## Purpose

Groups engagement HTTP adapters.
...
Mounted by runtime under backoffice routes.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Engagement Transport Boundary"]
