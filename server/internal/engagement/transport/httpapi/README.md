<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/engagement/transport/httpapi`.
Responsibilities:
...
Adapts engagement services to authenticated HTTP endpoints.

## Contained components

Handlers for bookmarks, alerts, notifications, and related responses.
...
Depends on auth middleware context and engagement application service.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Engagement HTTP API"]
