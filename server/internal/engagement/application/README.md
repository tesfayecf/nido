<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/engagement/application`.
Responsibilities:
...
# Engagement Application Layer

## Purpose

Coordinates bookmark, alert, notification, and event-driven engagement behavior.

## Contained components

Notifier and service logic with tests.
...
Depends on engagement domain and platform events/persistence.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Engagement Application Layer"]
