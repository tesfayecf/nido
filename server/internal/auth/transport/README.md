<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/auth/transport`.
Responsibilities:
...
Consumed by runtime route registration.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Auth Transport Boundary"]
