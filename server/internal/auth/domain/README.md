<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/auth/domain`.
Responsibilities:
...
Consumed by auth application, transport, and SQLite store.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Auth Domain Layer"]
