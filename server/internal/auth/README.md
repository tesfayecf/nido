<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/auth`.
Responsibilities:
...
Owns users, sessions, bearer-token auth, and profile/password flows.

## Contained components

Application service, domain models, and HTTP transport.
...
Upstream: runtime/config/sqlite. Downstream: protected API middleware consumers.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Authentication Module"]
