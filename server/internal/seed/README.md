<!--
File Name: README.md
Purpose: Provides folder-level documentation for `internal/seed`.
Responsibilities:
...
Creates deterministic local/demo data.

## Contained components

Seed helpers and tests.
...
Consumed by local helper workflows and development setup.
...
```mermaid
flowchart LR
    Parent["Parent folder"] --> This["Seed Module"]
